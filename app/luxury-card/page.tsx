        ...
        <FadeInWhenVisible delay={0.4}>
          <PageContent title="Context">
            <p>
              ...
              that enhanced usability while preserving the brand&apos;s
              identity. My responsibilities extended to leading the design team
              and ensuring a smooth handover to development.
            </p>
          </PageContent>
        </FadeInWhenVisible>
      </section>
      ...
      <section className="mt-10 space-y-6">
        <FadeInWhenVisible delay={0.6}>
          <PageContent title="UX Audit">
            <p>
              An initial UX audit revealed significant usability issues within
              the app. Key UI elements were missing, hindering navigation, and
              critical user flows were incomplete, leading to user frustration
              and confusion.
            </p>
          </PageContent>
        </FadeInWhenVisible>
      ...
      <section className="mt-10 space-y-6">
        <FadeInWhenVisible delay={1}>
          <PageContent title="Experience Redesigned">
            <p>
              To elevate the overall user experience and deliver a truly
              luxurious feel, I spearheaded the redesign of both the UX and UI.
              By meticulously mapping out user flows and stories, I established
              clear paths for users to navigate the app&apos;s features. The
              redesigned UI captured the essence of the brand&apos;s luxury
              aesthetic while prioritizing simplicity and efficiency, catering
              to the discerning tastes of the target audience. A key feature,
              the concierge chat, was seamlessly integrated with the booking
              section for a more streamlined and convenient user journey.
            </p>
          </PageContent>
        </FadeInWhenVisible>
