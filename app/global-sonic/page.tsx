    ...
    <div>
      ...
      <section className="mt-10 space-y-4">
        ...
        <PageContent title="Overview">
          <p>
            Tasked with revolutionizing the fire alarm system user experience, I
            was hired by Global Sonic as the Product Design Lead. Collaborating
            closely with product owners and developers, I developed a
            groundbreaking software solution. Global Sonic sought a departure
            from traditional fire alarm panels, inspiring me to create a design
            that excelled in both aesthetics and usability. Balancing innovative
            design with stringent regulatory requirements for fire alarm panels
            presented a significant challenge. Additionally, the shift from a
            horizontal to vertical screen format necessitated a complete
      ...
      <section className="mt-10 space-y-6">
        <PageContent title="The Existing Product">
          <p>
            ...
            software&apos;s underlying design and functionality closely mirrored
            traditional fire alarm systems, presenting an opportunity to
            innovate and create a truly differentiated product.
          </p>
        </PageContent>
      ...
      <section className="mt-10 space-y-6">
        <PageContent title="The Process">
          ...
          <p>
            ...
            experience with additional features and visualization options on the
            home screen.
          </p>
          <p>
            The research process included going deep into softwares like Cars
            Interfaces and complex dashboards, so we could break the pattern of
            the alarm industry.
          </p>
        </PageContent>
