...
export function SocialMedia() {
    return (
        <div>{SocialMediaData.map((social, index) => (
            <div key={index} className="flex items-center gap-1 mb-10 text-sm leading-5 hover:text-primary transition-all duration-500 ease">  
            <p>{social.text}</p>
